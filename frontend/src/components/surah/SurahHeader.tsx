  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-[#21253a] to-[#1a1d27] border border-[#2d3250] p-6 mb-6 text-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-2 right-4 text-[120px] text-[#c9a84c] font-arabic leading-none select-none"
      ...
      <div className="relative z-10">
        ...
        <p className="text-[#9da3c0] text-sm mb-4">{surah.englishNameTranslation}</p>

        {/* Meta badges */}
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <span className="px-3 py-1 rounded-full bg-[#2d3250] text-[#9da3c0] text-xs">
            Surah {surah.number}
          </span>
          <span className="px-3 py-1 rounded-full bg-[#2d3250] text-[#9da3c0] text-xs">
