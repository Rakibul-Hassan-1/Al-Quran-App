import type { Surah, Ayah, QuranData } from "../types";
...
const SURAH_META: Array<{
  ...
  { number: 36, name: "يس", englishName: "Yaseen", englishNameTranslation: "Ya-Seen", numberOfAyahs: 83, revelationType: "Meccan" },
  { number: 37, name: "الصافات", englishName: "As-Saaffaat", englishNameTranslation: "Those Ranged in Ranks", numberOfAyahs: 182, revelationType: "Meccan" },
  ...
  { number: 82, name: "الإنفطار", englishName: "Al-Infitaar", englishNameTranslation: "The Cleaving", numberOfAyahs: 19, revelationType: "Meccan" },
  ...
  { number: 84, name: "الإنشقاق", englishName: "Al-Inshiqaaq", englishNameTranslation: "The Sundering", numberOfAyahs: 25, revelationType: "Meccan" },
  ...
  { number: 107, name: "الماعون", englishName: "Al-Maa'un", englishNameTranslation: "The Small Kindnesses", numberOfAyahs: 7, revelationType: "Meccan" },
...
export async function loadQuranData(): Promise<QuranData> {
  ...
  try {
    ...
    const surahs: Surah[] = arabicSurahs.map((arabicSurah: any, index: number) => {
      const englishSurah = englishSurahs[index];
      const meta = SURAH_META[index];

      const ayahs: Ayah[] = arabicSurah.ayahs.map((arabicAyah: any, ayahIndex: number) => ({
